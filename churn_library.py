'''
this module contains functions to read in the data perform EDA, Feature Engineering

and train a predictive model to predict the customers who are more likely to churn.
